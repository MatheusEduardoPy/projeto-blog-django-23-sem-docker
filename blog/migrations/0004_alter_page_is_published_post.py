...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='page',
            name='is_published',
            field=models.BooleanField(default=False, help_text='Esse campo precisa estar marcado para a página ser exibida publicamente'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_published', models.BooleanField(default=False, help_text='Esse campo precisa estar marcado para o post ser exibido publicamente')),
